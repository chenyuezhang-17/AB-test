#!/bin/bash
# Hourly runner for daily auto. Script checks PT time internally — skips if outside window.

LOCK="/tmp/leego-daily.lock"
...
caffeinate -i /opt/homebrew/bin/python3 /Users/lessie/cc/AB-test/daily_auto.py >> "$LOG" 2>&1
